...
- `markt-simulator.html` – **Marktnachfrage-Simulator** für den Wirtschaftsunterricht
  ...
  Neun Güter mit ökonomisch passenden Komplementär- und Substitutionsgütern, reaktive
  Pixel-Marktwelt, geführte Missionen nach dem Muster Prognostizieren → Berechnen →
...
- `markt-simulator-offline.html` – inhaltsgleiche Fassung mit eingebetteten Bibliotheken
  (ca. 355 KB). Läuft ohne Internetverbindung, z. B. nach Verteilung per AirDrop.
