...
# -*- coding: utf-8 -*-
"""
Bettet die Bilddateien aus assets/icons/ und assets/marktwelt/ als Daten-URIs
in markt-simulator.html ein.
...
ORDNER = [os.path.join(WURZEL, 'assets', 'icons'),
          os.path.join(WURZEL, 'assets', 'marktwelt')]
...
def main():
    ...
    block = (ANFANG + "\n// Hinterlegte Bilddateien aus assets/ – erzeugt von tools/icons_einbetten.py.\n"
    ...
    kb = sum(os.path.getsize(p) for p in dateien) / 1024
